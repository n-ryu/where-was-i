...
export const sampleActiveTodayTodos: Todo[] = [
  makeTodo({
    id: 'todo-1',
  ...
  makeTodo({
    ...
    updatedAt: new Date('2025-06-01T09:30:00'),
  }),
]

export const sampleIdleTodos: Todo[] = [
  makeTodo({ id: 'todo-3', title: 'Review pull request #42' }),
  makeTodo({ id: 'todo-4', title: 'Set up CI/CD pipeline' }),
]

export const sampleCompletedTodayTodos: Todo[] = [
  makeTodo({
    id: 'todo-5',
