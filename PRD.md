...
### Progressive Form (Auto-Advance Form)

- 폼의 경우 Progressive Form 형태로 구현
- 사용자가 단계별 스텝을 쉽게 따라갈 수 있도록 구성
- 각 단계가 완료되면 자동으로 다음 단계로 진행
...
오늘 Task가 없으면 계획 페이지로 자동 이동. Progressive Form 형태로 구현.
